...
2. Formatting text (e.g., convert this text into a numbered list).
    1. ~~`Markdown formatting instructions`.~~ This is not done be LLM anymore. See https://github.com/parsiya/markdown-formatting.

[refine]: https://github.com/parsiya/parsiya.net/tree/main/.github/skills/refine/SKILLS.md

## Tracking
I have no tracking on this website. It's static HTML generated by Hugo and the
entire website only has a couple of lines of JavaScript. It's hosted on GitHub
pages ([source][src]) so GitHub might log traffic, but I have no visibility.
